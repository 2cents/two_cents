...
urlpatterns = patterns('',
    ...
    url(r'^get_latest_pub_submissions/$', views.get_latest_pub_submissions, name='get_latest_pub_submissions'),
    ...
    url(r'^save_pub_desc$', views.save_pub_desc, name='save_pub_desc'),
    ...
    url(r'^get_replies$', views.get_replies, name='get_replies'),
    url(r'^get_full_replies$', views.get_full_replies, name='get_full_replies'),
    ...
    url(r'^change_subs$', views.change_subs, name='change_subs'),
